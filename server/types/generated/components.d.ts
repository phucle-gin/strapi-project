...
export interface BlocksParagraphWithMedia extends Struct.ComponentSchema {
  collectionName: 'components_blocks_paragraph_with_media';
  info: {
    displayName: 'Paragraph With Media';
  };
  attributes: {
    content: Schema.Attribute.RichText;
    imageLandscape: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'blocks.paragraph-with-media': BlocksParagraphWithMedia;
